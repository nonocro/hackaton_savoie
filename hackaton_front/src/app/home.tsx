    ...
    <div className="flex flex-col min-h-screen">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Visualisez les zones de besoins en médecins généralistes et
                    prenez des décisions éclairées grâce à notre outil d'analyse
                    démographique et statistique.
                  </p>
                </div>
              ...
              <div className="mx-auto w-full max-w-[500px] lg:max-w-none relative">
                <div className="aspect-video overflow-hidden rounded-xl border bg-white shadow-xl">
                  ...
                  <div className="relative h-full bg-gray-50">
                    ...
                    <div className="absolute top-4 left-4 right-4 bg-white rounded-lg shadow-lg p-3 flex items-center">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Notre outil vous offre une analyse complète pour optimiser
                  l'implantation de centres médicaux
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-8">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-gray-500">
                  Visualisez les zones géographiques selon la densité de
                  médecins généralistes et les besoins de la population.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="rounded-full bg-teal-100 p-3">
                ...
                <p className="text-center text-gray-500">
                  Accédez aux données démographiques détaillées pour comprendre
                  la composition de la population locale.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="rounded-full bg-teal-100 p-3">
                ...
                <p className="text-center text-gray-500">
                  Explorez des indicateurs clés pour évaluer la pertinence
                  d'implantation d'un centre médical.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid gap-10 lg:grid-cols-2 items-center">
              <div className="space-y-4">
                ...
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Notre application vous guide à travers un processus simple
                  pour analyser les zones d'implantation potentielles.
                </p>
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-500">
                        Utilisez notre carte interactive pour sélectionner la
                        région qui vous intéresse.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-500">
                        Consultez les statistiques démographiques et la
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      <h3 className="font-bold">
                        Évaluez la pertinence d'implantation
                      </h3>
                      <p className="text-gray-500">
                        Utilisez nos indicateurs pour déterminer si la zone est
                        propice à l'implantation d'un centre médical.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Commencez dès maintenant à explorer les zones de besoins en
                  médecins généralistes.
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full border-t px-4 md:px-6">
        <p className="text-xs text-gray-500">
          © 2023 MédicoMap. Tous droits réservés.
        </p>
